    ...
    if (entity->info & 0x40000) {
        ...
        switch (entity->def->eType) {
            ...
            case 1: // Enemy
                ...
                sprite->ent->monster->animFrameTime = (entity->doomRpg->doomCanvas->time + 250) % MAXTICKS;
...
int Entity_calcWorldDistance(Entity_t* entity, int x, int y)
{
    ...
    //Hud_addMessage(entity->doomRpg->hud, "calc world dist"); //new
...
int Entity_calcPath(Entity_t* entity, int srcX, int srcY, int destX, int destY, int n5, int n6)
{
    ...
    //Hud_addMessage(entity->doomRpg->hud, "calc path"); //new
...
void Entity_touched(Entity_t* entity)
{
    ...
    switch (entity->def->eType)
    {
        case 3: {
            ...
            hud->gotFaceTime = (entity->doomRpg->doomCanvas->time + 500)% MAXTICKS;
