...
void Render_getSpanMode(Render_t* render, int palOffset, byte spanMode); //new
void Render_SpanMode0a(Render_t* render, int param_2, int param_3, int param_4, int param_5, int param_6);
void Render_SpanMode0b(Render_t* render, int param_2, int param_3, int param_4, int param_5, int param_6); //new
